...
// Initialize chart
const initChart = () => {
  console.log('BarChart initChart called', chartRef.value, echarts)
  if (chartRef.value) {
    try {
...
const updateChart = () => {
  console.log('BarChart updateChart called, chartInstance:', chartInstance, 'props:', props)
  if (chartInstance) {
    try {
    ...
    console.warn('No chartInstance available')
  }
}
